    ...
    <section className="about-section py-16 px-4 md:px-8 max-w-7xl mx-auto">
      <div className="grid md:grid-cols-2 gap-8 mb-16">
        ...
        <div className="content-img flex justify-center items-center">
          <div className="w-full max-w-md aspect-square rounded-2xl bg-gradient-to-br from-primary/10 to-secondary/10 backdrop-blur-sm shadow-xl transform hover:scale-105 transition-transform duration-300">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="content-img flex justify-center items-center">
          <div className="w-full max-w-md aspect-square rounded-2xl bg-gradient-to-bl from-secondary/10 to-primary/10 backdrop-blur-sm shadow-xl transform hover:scale-105 transition-transform duration-300">
            {/* Image placeholder - replace with actual image */}
          </div>
        </div>
        <div className="content-inner flex flex-col justify-center space-y-6">
