...
const AuthLayout: React.FC<AuthLayoutProps> = ({ children, onSubmit, title }) => {
  return (
    <MainLayout>
      <div className={`flex justify-center items-center h-${title != "Login" ? "auto" : "screen"} p-10`}>
        <Form
        ...
        >
          <div className="textbox w-[20rem] flex flex-col gap-2">
            <Title>Selamat Datang {title === "register" ? "👋 Kenalan Dulu Yuk" : "Kembali"}</Title>
          ...
          <p className="flex items-center gap-1">
            ...
            <Link to={"/login"} className="font-bold hover:text-violet-500">
